...
// so break up your interfaces into lot of little interfaces and use which one
// is needed only
#include <iostream>
using namespace std;
...
Not acceptable as client will have to implment scan and fax even if it does not
use it
*/
...
// one can use multiple inheritance to use more than one interface or use
// decorator pattern
